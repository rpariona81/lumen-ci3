                        ...
                        <tbody>
                            <?php foreach ($query as $item) : ?>
                                <tr class="align-middle">
                                    <td class="px-2"><?= str_pad($item->career_offered_code, 5, '0', STR_PAD_LEFT); ?></td>
                                    <td><?= $item->career_offered ?></td>
                                    <td>
                                        <div class="btn-group" role="group" aria-label="Basic example">
                                            ...
                                            &nbsp;&nbsp;<?= form_open('admin/removeProgram', array('class' => 'form-horizontal')); ?>
