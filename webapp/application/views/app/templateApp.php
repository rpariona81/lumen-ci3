        ...
        <div class="page d-flex flex-row flex-column-fluid">
            ...
            <div class="wrapper d-flex flex-column flex-row-fluid" id="kt_wrapper">
                    ...
                    <div class="container-xxl d-flex align-items-stretch justify-content-between">
                        ...
                        <div class="d-flex align-items-center flex-grow-1 flex-lg-grow-0 me-lg-15">
                            <a href="<?= base_url('/' . $this->session->userdata('User_guard')) ?>">
                                ...
                                <img alt="Logo"
                                    src="<?php echo (ENVIRONMENT === 'development') ?  'assets/media/logos/escudo.jpg'  : base_url() . getenv('APP_LOGO') ?>"
                ...
                <div class="content d-flex flex-column flex-column-fluid" id="kt_content">
                    <!--begin::Toolbar-->
                    <div class="toolbar" id="kt_toolbar" style="background-color: #ED6237;">
                        <!--begin::Container-->
                        <div id="kt_toolbar_container" class="container-xxl d-flex flex-stack">
                            ...
                            <div data-kt-swapper="true" data-kt-swapper-mode="prepend"
                                ...
                                <h1 class="d-flex align-items-center text-light fw-bolder fs-3 my-1">
                                    <?= $pagina_title ?? '' ?></h1>
                                <!--end::Title-->
                            </div>
                            <!--end::Page title-->
